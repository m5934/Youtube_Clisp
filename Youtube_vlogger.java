...
class AutoDemo implements ActionListener {
    ...
    AutoDemo() {
        try {
//            autoResources = ResourceBundle.getBundle("resources.AutoResources", new Locale("pl", "PL") );
            autoResources = ResourceBundle.getBundle("resources.AutoResources", Locale.ENGLISH);
